...
const tiers = [
  {
    ...
    features: ["Unlimited Projects", "Unlimited Action Schemas"],
  },
  {
    id: "premium",
    name: "Premium (Cloud)",
    ...
    features: [
      "Unlimited Projects",
      "Unlimited Action Schemas",
      "1,000 actions",
      "500 Identifier On-Chain state publications",
      "Product Support",
    ],
  },
];
      ...
      <div className="relative overflow-hidden pt-32 pb-96 lg:pt-40">
        ...
        <div className="relative mx-auto max-w-7xl px-6 text-center lg:px-8">
          <div className="mx-auto max-w-2xl lg:max-w-4xl">
            <h2 className="text-lg font-semibold leading-8 text-purple-500">
              Pricing
            </h2>
              ...
              {tiers.map((tier) => (
                ...
                >
                  <div className="p-8 sm:p-10">
                    <h3
                      className="text-lg font-semibold leading-8 tracking-tight text-purple-500"
                      id={tier.id}
                    >
                      {tier.name}
                    </h3>
                  ...
                  <div className="flex flex-1 flex-col p-2">
                    <div className="flex flex-1 flex-col justify-between rounded-2xl bg-gray-50 p-6 sm:p-8">
                      ...
                      <div className="mt-8">
                        <Link
                          to="/app/signup"
                          className="inline-block w-full rounded-lg bg-purple-500 px-4 py-2.5 text-center text-sm font-semibold leading-5 text-white shadow-md hover:bg-purple-700"
